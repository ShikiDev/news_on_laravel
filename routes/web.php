...
Route::get('/admin/news/update/{id}','NewsController@edit')->name('edit')->middleware('auth');
Route::post('/admin/news/store','NewsController@update')->name('update')->middleware('auth');
